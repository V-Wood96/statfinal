...
# 7.1 Adjusted predicted probabilities by foundation
...
# 7.2 Odds-ratio plot (log scale) for key predictors
coef_df <- data.frame(
...
ggsave("HighRevenue_OR_plot.png", width = 7, height = 4, dpi = 300)

## -----------------------------------------------------------
## Q1: Which org characteristics most strongly predict HighIncome?
##     (NTEE major, GroupStatus, State, ACCT_PD, Assets, Revenue)
## -----------------------------------------------------------
...
# NTEE_major: first letter of NTEE code (if not already present)
...
## Logistic regression (HighIncome)
...
## -----------------------------------------------------------
## Q2: Does geography (STATE) meaningfully predict HighRevenue?
## -----------------------------------------------------------
...
# HighRevenue: above/below median revenue (NOTE: overrides any prior HighRevenue)
...
# "Typical" state whose high-revenue share is closest to national average
